<div class="modal fade" id="filter-form" role="dialog" aria-labelledby="filter-form">
    <div class="modal-dialog" role="document">
        <form action="{{ route('penerimaanbarang.cetaklist')}}" method="get" class="form-horizontal" id="formFilter">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal-form">Cetak Penerimaan Barang</h4>
